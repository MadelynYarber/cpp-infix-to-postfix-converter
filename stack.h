...
//returns true if every element in Stack a is smaller than or equal to the corresponding element of Statck b, i.e., if repeatedly invoking top() and pop() on both a and b,  
